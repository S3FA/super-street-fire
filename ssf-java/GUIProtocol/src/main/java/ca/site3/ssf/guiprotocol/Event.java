...
public final class Event {
  ...
  public interface GameEventOrBuilder
    ...
    // repeated .guiprotocol.GameEvent.BoardStatus boardStatus = 21;
    java.util.List<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus> 
        getBoardStatusList();
    ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus getBoardStatus(int index);
    int getBoardStatusCount();
    java.util.List<? extends ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder> 
        getBoardStatusOrBuilderList();
    ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder getBoardStatusOrBuilder(
        int index);
    
    // optional bool player1UnlimitedMovesOn = 22;
    boolean hasPlayer1UnlimitedMovesOn();
    boolean getPlayer1UnlimitedMovesOn();
    
    // optional bool player2UnlimitedMovesOn = 23;
    boolean hasPlayer2UnlimitedMovesOn();
    boolean getPlayer2UnlimitedMovesOn();
    ...
    boolean hasBlockWasEffective();
    boolean getBlockWasEffective();
    
    // optional int32 blockWindowID = 26;
    boolean hasBlockWindowID();
    int getBlockWindowID();
    
    // optional bool blockWindowHasExpired = 27;
    boolean hasBlockWindowHasExpired();
    boolean getBlockWindowHasExpired();
    
    // optional double blockWindowTimeInSecs = 28;
    boolean hasBlockWindowTimeInSecs();
    double getBlockWindowTimeInSecs();
    
    // optional int32 blockingPlayerNumber = 29;
    boolean hasBlockingPlayerNumber();
    int getBlockingPlayerNumber();
    
    // optional float oldActionPoints = 30;
    boolean hasOldActionPoints();
    float getOldActionPoints();
    
    // optional float newActionPoints = 31;
    boolean hasNewActionPoints();
    float getNewActionPoints();
  ...
  public static final class GameEvent extends
    ...
    public enum EventType
      ...
      BLOCK_WINDOW(13, 13),
      PLAYER_ACTION_POINTS_CHANGED(14, 14),
      PLAYER_ATTACK_ACTION_FAILED(15, 15),
      ;
      ...
      public static final int BLOCK_WINDOW_VALUE = 13;
      public static final int PLAYER_ACTION_POINTS_CHANGED_VALUE = 14;
      public static final int PLAYER_ATTACK_ACTION_FAILED_VALUE = 15;
      ...
      public static EventType valueOf(int value) {
        switch (value) {
          ...
          case 13: return BLOCK_WINDOW;
          case 14: return PLAYER_ACTION_POINTS_CHANGED;
          case 15: return PLAYER_ATTACK_ACTION_FAILED;
          default: return null;
        }
      }
      ...
      private static final EventType[] VALUES = {
        GAME_INFO_REFRESH, FIRE_EMITTER_CHANGED, GAME_STATE_CHANGED, PLAYER_HEALTH_CHANGED, ROUND_PLAY_TIMER_CHANGED, ROUND_BEGIN_TIMER_CHANGED, ROUND_ENDED, MATCH_ENDED, PLAYER_ATTACK_ACTION, PLAYER_BLOCK_ACTION, RINGMASTER_ACTION, SYSTEM_INFO_REFRESH, UNRECOGNIZED_GESTURE, BLOCK_WINDOW, PLAYER_ACTION_POINTS_CHANGED, PLAYER_ATTACK_ACTION_FAILED, 
      };
    ...
    public enum AttackFailureReason
        implements com.google.protobuf.ProtocolMessageEnum {
      NOT_ENOUGH_ACTION_POINTS(0, 0),
      ;
      
      public static final int NOT_ENOUGH_ACTION_POINTS_VALUE = 0;
      
      
      public final int getNumber() { return value; }
      
      public static AttackFailureReason valueOf(int value) {
        switch (value) {
          case 0: return NOT_ENOUGH_ACTION_POINTS;
          default: return null;
        }
      }
      
      public static com.google.protobuf.Internal.EnumLiteMap<AttackFailureReason>
          internalGetValueMap() {
        return internalValueMap;
      }
      private static com.google.protobuf.Internal.EnumLiteMap<AttackFailureReason>
          internalValueMap =
            new com.google.protobuf.Internal.EnumLiteMap<AttackFailureReason>() {
              public AttackFailureReason findValueByNumber(int number) {
                return AttackFailureReason.valueOf(number);
              }
            };
      ...
      private static final AttackFailureReason[] VALUES = {
        NOT_ENOUGH_ACTION_POINTS, 
      };
      
      public static AttackFailureReason valueOf(
          com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
        if (desc.getType() != getDescriptor()) {
          throw new java.lang.IllegalArgumentException(
            "EnumValueDescriptor is not for this type.");
      ...
      private AttackFailureReason(int index, int value) {
        this.index = index;
        this.value = value;
      }
      
      // @@protoc_insertion_point(enum_scope:guiprotocol.GameEvent.AttackFailureReason)
    }
    ...
    public interface BoardStatusOrBuilder
        extends com.google.protobuf.MessageOrBuilder {
    ...
    public static final class BoardStatus extends
        com.google.protobuf.GeneratedMessage
        implements BoardStatusOrBuilder {
      // Use BoardStatus.newBuilder() to construct.
      private BoardStatus(Builder builder) {
        super(builder);
      }
      private BoardStatus(boolean noInit) {}
      
      private static final BoardStatus defaultInstance;
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ca.site3.ssf.guiprotocol.Event.internal_static_guiprotocol_GameEvent_BoardStatus_descriptor;
      }
      
      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return ca.site3.ssf.guiprotocol.Event.internal_static_guiprotocol_GameEvent_BoardStatus_fieldAccessorTable;
      }
      ...
      // required bool armed = 3;
      public static final int ARMED_FIELD_NUMBER = 3;
      ...
      // required bool flame = 4;
      public static final int FLAME_FIELD_NUMBER = 4;
      private boolean flame_;
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (((bitField0_ & 0x00000002) == 0x00000002)) {
          output.writeBool(2, responding_);
        }
        if (((bitField0_ & 0x00000004) == 0x00000004)) {
          output.writeBool(3, armed_);
        }
        if (((bitField0_ & 0x00000008) == 0x00000008)) {
          output.writeBool(4, flame_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000002) == 0x00000002)) {
          size += com.google.protobuf.CodedOutputStream
            .computeBoolSize(2, responding_);
        }
        if (((bitField0_ & 0x00000004) == 0x00000004)) {
          size += com.google.protobuf.CodedOutputStream
            .computeBoolSize(3, armed_);
        }
        if (((bitField0_ & 0x00000008) == 0x00000008)) {
          size += com.google.protobuf.CodedOutputStream
            .computeBoolSize(4, flame_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSerializedSize = size;
        return size;
      ...
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseFrom(
          com.google.protobuf.ByteString data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return newBuilder().mergeFrom(data).buildParsed();
      }
      ...
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return newBuilder().mergeFrom(data).buildParsed();
      }
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseFrom(
      ...
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return newBuilder().mergeFrom(input).buildParsed();
      }
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseFrom(
      ...
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        Builder builder = newBuilder();
        if (builder.mergeDelimitedFrom(input)) {
          return builder.buildParsed();
      ...
      public static ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Builder builder = newBuilder();
      ...
      public static Builder newBuilder() { return Builder.create(); }
      public Builder newBuilderForType() { return newBuilder(); }
      public static Builder newBuilder(ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus prototype) {
        return newBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() { return newBuilder(this); }
      ...
      public static final class Builder extends
          com.google.protobuf.GeneratedMessage.Builder<Builder>
         implements ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return ca.site3.ssf.guiprotocol.Event.internal_static_guiprotocol_GameEvent_BoardStatus_descriptor;
        }
        ...
        // Construct using ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.newBuilder()
        private Builder() {
          maybeForceBuilderInitialization();
        }
        ...
        public com.google.protobuf.Descriptors.Descriptor
            getDescriptorForType() {
          return ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.getDescriptor();
        }
        
        public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus getDefaultInstanceForType() {
          return ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.getDefaultInstance();
        }
        
        public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus build() {
          ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        private ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus buildParsed()
            throws com.google.protobuf.InvalidProtocolBufferException {
          ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(
        ...
        public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus buildPartial() {
          ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus result = new ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus(this);
          int from_bitField0_ = bitField0_;
          int to_bitField0_ = 0;
          if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
            to_bitField0_ |= 0x00000001;
          ...
          result.responding_ = responding_;
          if (((from_bitField0_ & 0x00000004) == 0x00000004)) {
            to_bitField0_ |= 0x00000004;
          }
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus) {
            return mergeFrom((ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus other) {
          if (other == ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.getDefaultInstance()) return this;
          if (other.hasDeviceId()) {
            setDeviceId(other.getDeviceId());
          }
          if (other.hasResponding()) {
            setResponding(other.getResponding());
          }
          if (other.hasArmed()) {
            setArmed(other.getArmed());
          }
          if (other.hasFlame()) {
            setFlame(other.getFlame());
          }
          this.mergeUnknownFields(other.getUnknownFields());
          return this;
        }
        ...
        public Builder setResponding(boolean value) {
          bitField0_ |= 0x00000002;
          responding_ = value;
          onChanged();
          return this;
        ...
        public Builder setFlame(boolean value) {
          bitField0_ |= 0x00000008;
          flame_ = value;
          onChanged();
          return this;
        ...
        // @@protoc_insertion_point(builder_scope:guiprotocol.GameEvent.BoardStatus)
      }
      
      static {
        defaultInstance = new BoardStatus(true);
        defaultInstance.initFields();
      }
      
      // @@protoc_insertion_point(class_scope:guiprotocol.GameEvent.BoardStatus)
    }
    ...
    // repeated .guiprotocol.GameEvent.BoardStatus boardStatus = 21;
    public static final int BOARDSTATUS_FIELD_NUMBER = 21;
    private java.util.List<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus> boardStatus_;
    public java.util.List<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus> getBoardStatusList() {
      return boardStatus_;
    }
    public java.util.List<? extends ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder> 
        getBoardStatusOrBuilderList() {
      return boardStatus_;
    }
    public int getBoardStatusCount() {
      return boardStatus_.size();
    }
    public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus getBoardStatus(int index) {
      return boardStatus_.get(index);
    }
    public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder getBoardStatusOrBuilder(
        int index) {
      return boardStatus_.get(index);
    }
    
    // optional bool player1UnlimitedMovesOn = 22;
    public static final int PLAYER1UNLIMITEDMOVESON_FIELD_NUMBER = 22;
    private boolean player1UnlimitedMovesOn_;
    public boolean hasPlayer1UnlimitedMovesOn() {
      return ((bitField0_ & 0x00040000) == 0x00040000);
    }
    public boolean getPlayer1UnlimitedMovesOn() {
      return player1UnlimitedMovesOn_;
    }
    
    // optional bool player2UnlimitedMovesOn = 23;
    public static final int PLAYER2UNLIMITEDMOVESON_FIELD_NUMBER = 23;
    private boolean player2UnlimitedMovesOn_;
    public boolean hasPlayer2UnlimitedMovesOn() {
      return ((bitField0_ & 0x00080000) == 0x00080000);
    }
    public boolean getPlayer2UnlimitedMovesOn() {
      return player2UnlimitedMovesOn_;
    }
    
    // optional .guiprotocol.GameEvent.RingmasterActionType ringmasterActionType = 24;
    public static final int RINGMASTERACTIONTYPE_FIELD_NUMBER = 24;
    ...
    // optional bool blockWasEffective = 25;
    public static final int BLOCKWASEFFECTIVE_FIELD_NUMBER = 25;
    private boolean blockWasEffective_;
    public boolean hasBlockWasEffective() {
      return ((bitField0_ & 0x00200000) == 0x00200000);
    }
    public boolean getBlockWasEffective() {
      return blockWasEffective_;
    }
    
    // optional int32 blockWindowID = 26;
    public static final int BLOCKWINDOWID_FIELD_NUMBER = 26;
    private int blockWindowID_;
    public boolean hasBlockWindowID() {
      return ((bitField0_ & 0x00400000) == 0x00400000);
    }
    public int getBlockWindowID() {
      return blockWindowID_;
    }
    
    // optional bool blockWindowHasExpired = 27;
    public static final int BLOCKWINDOWHASEXPIRED_FIELD_NUMBER = 27;
    private boolean blockWindowHasExpired_;
    public boolean hasBlockWindowHasExpired() {
      return ((bitField0_ & 0x00800000) == 0x00800000);
    }
    public boolean getBlockWindowHasExpired() {
      return blockWindowHasExpired_;
    }
    
    // optional double blockWindowTimeInSecs = 28;
    public static final int BLOCKWINDOWTIMEINSECS_FIELD_NUMBER = 28;
    private double blockWindowTimeInSecs_;
    public boolean hasBlockWindowTimeInSecs() {
      return ((bitField0_ & 0x01000000) == 0x01000000);
    }
    public double getBlockWindowTimeInSecs() {
      return blockWindowTimeInSecs_;
    }
    
    // optional int32 blockingPlayerNumber = 29;
    public static final int BLOCKINGPLAYERNUMBER_FIELD_NUMBER = 29;
    private int blockingPlayerNumber_;
    public boolean hasBlockingPlayerNumber() {
      return ((bitField0_ & 0x02000000) == 0x02000000);
    }
    public int getBlockingPlayerNumber() {
      return blockingPlayerNumber_;
    }
    
    // optional float oldActionPoints = 30;
    public static final int OLDACTIONPOINTS_FIELD_NUMBER = 30;
    private float oldActionPoints_;
    public boolean hasOldActionPoints() {
      return ((bitField0_ & 0x04000000) == 0x04000000);
    }
    public float getOldActionPoints() {
      return oldActionPoints_;
    }
    
    // optional float newActionPoints = 31;
    public static final int NEWACTIONPOINTS_FIELD_NUMBER = 31;
    private float newActionPoints_;
    public boolean hasNewActionPoints() {
      return ((bitField0_ & 0x08000000) == 0x08000000);
    }
    public float getNewActionPoints() {
      return newActionPoints_;
    }
    
    // optional .guiprotocol.GameEvent.AttackFailureReason attackFailureReason = 32;
    public static final int ATTACKFAILUREREASON_FIELD_NUMBER = 32;
    private ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason attackFailureReason_;
    public boolean hasAttackFailureReason() {
      return ((bitField0_ & 0x10000000) == 0x10000000);
    }
    public ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason getAttackFailureReason() {
    ...
    private void initFields() {
      ...
      player2Health_ = 0F;
      roundInPlayTimer_ = 0;
      boardStatus_ = java.util.Collections.emptyList();
      ...
      blockWasEffective_ = false;
      blockWindowID_ = 0;
      blockWindowHasExpired_ = false;
      blockWindowTimeInSecs_ = 0D;
      blockingPlayerNumber_ = 0;
      oldActionPoints_ = 0F;
      newActionPoints_ = 0F;
    ...
    public final boolean isInitialized() {
      ...
      for (int i = 0; i < getBoardStatusCount(); i++) {
        if (!getBoardStatus(i).isInitialized()) {
          memoizedIsInitialized = 0;
          return false;
        }
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < boardStatus_.size(); i++) {
        output.writeMessage(21, boardStatus_.get(i));
      }
      if (((bitField0_ & 0x00040000) == 0x00040000)) {
        output.writeBool(22, player1UnlimitedMovesOn_);
      }
      if (((bitField0_ & 0x00080000) == 0x00080000)) {
        output.writeBool(23, player2UnlimitedMovesOn_);
      }
      if (((bitField0_ & 0x00100000) == 0x00100000)) {
        output.writeEnum(24, ringmasterActionType_.getNumber());
      }
      if (((bitField0_ & 0x00200000) == 0x00200000)) {
        output.writeBool(25, blockWasEffective_);
      }
      if (((bitField0_ & 0x00400000) == 0x00400000)) {
        output.writeInt32(26, blockWindowID_);
      }
      if (((bitField0_ & 0x00800000) == 0x00800000)) {
        output.writeBool(27, blockWindowHasExpired_);
      }
      if (((bitField0_ & 0x01000000) == 0x01000000)) {
        output.writeDouble(28, blockWindowTimeInSecs_);
      }
      if (((bitField0_ & 0x02000000) == 0x02000000)) {
        output.writeInt32(29, blockingPlayerNumber_);
      }
      if (((bitField0_ & 0x04000000) == 0x04000000)) {
        output.writeFloat(30, oldActionPoints_);
      }
      if (((bitField0_ & 0x08000000) == 0x08000000)) {
        output.writeFloat(31, newActionPoints_);
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < boardStatus_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(21, boardStatus_.get(i));
      }
      if (((bitField0_ & 0x00040000) == 0x00040000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(22, player1UnlimitedMovesOn_);
      }
      if (((bitField0_ & 0x00080000) == 0x00080000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(23, player2UnlimitedMovesOn_);
      }
      if (((bitField0_ & 0x00100000) == 0x00100000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(24, ringmasterActionType_.getNumber());
      }
      if (((bitField0_ & 0x00200000) == 0x00200000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(25, blockWasEffective_);
      }
      if (((bitField0_ & 0x00400000) == 0x00400000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(26, blockWindowID_);
      }
      if (((bitField0_ & 0x00800000) == 0x00800000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(27, blockWindowHasExpired_);
      }
      if (((bitField0_ & 0x01000000) == 0x01000000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeDoubleSize(28, blockWindowTimeInSecs_);
      }
      if (((bitField0_ & 0x02000000) == 0x02000000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(29, blockingPlayerNumber_);
      }
      if (((bitField0_ & 0x04000000) == 0x04000000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(30, oldActionPoints_);
      }
      if (((bitField0_ & 0x08000000) == 0x08000000)) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(31, newActionPoints_);
      }
      if (((bitField0_ & 0x10000000) == 0x10000000)) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        if (boardStatusBuilder_ == null) {
          boardStatus_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00080000);
        } else {
          boardStatusBuilder_.clear();
        }
        player1UnlimitedMovesOn_ = false;
      ...
      public ca.site3.ssf.guiprotocol.Event.GameEvent buildPartial() {
        ...
        if (boardStatusBuilder_ == null) {
          if (((bitField0_ & 0x00080000) == 0x00080000)) {
            boardStatus_ = java.util.Collections.unmodifiableList(boardStatus_);
            bitField0_ = (bitField0_ & ~0x00080000);
          }
          result.boardStatus_ = boardStatus_;
        } else {
          result.boardStatus_ = boardStatusBuilder_.build();
        }
        if (((from_bitField0_ & 0x00100000) == 0x00100000)) {
          to_bitField0_ |= 0x00040000;
        }
        result.player1UnlimitedMovesOn_ = player1UnlimitedMovesOn_;
        if (((from_bitField0_ & 0x00200000) == 0x00200000)) {
          to_bitField0_ |= 0x00080000;
        }
        result.player2UnlimitedMovesOn_ = player2UnlimitedMovesOn_;
        ...
        result.blockWasEffective_ = blockWasEffective_;
        if (((from_bitField0_ & 0x01000000) == 0x01000000)) {
          to_bitField0_ |= 0x00400000;
        }
        result.blockWindowID_ = blockWindowID_;
        if (((from_bitField0_ & 0x02000000) == 0x02000000)) {
          to_bitField0_ |= 0x00800000;
        }
        result.blockWindowHasExpired_ = blockWindowHasExpired_;
        if (((from_bitField0_ & 0x04000000) == 0x04000000)) {
          to_bitField0_ |= 0x01000000;
        }
        result.blockWindowTimeInSecs_ = blockWindowTimeInSecs_;
        if (((from_bitField0_ & 0x08000000) == 0x08000000)) {
          to_bitField0_ |= 0x02000000;
        }
        result.blockingPlayerNumber_ = blockingPlayerNumber_;
        if (((from_bitField0_ & 0x10000000) == 0x10000000)) {
          to_bitField0_ |= 0x04000000;
        }
        result.oldActionPoints_ = oldActionPoints_;
        if (((from_bitField0_ & 0x20000000) == 0x20000000)) {
          to_bitField0_ |= 0x08000000;
        }
        result.newActionPoints_ = newActionPoints_;
      ...
      public Builder mergeFrom(ca.site3.ssf.guiprotocol.Event.GameEvent other) {
        ...
        if (boardStatusBuilder_ == null) {
          if (!other.boardStatus_.isEmpty()) {
            if (boardStatus_.isEmpty()) {
              boardStatus_ = other.boardStatus_;
              bitField0_ = (bitField0_ & ~0x00080000);
            } else {
              ensureBoardStatusIsMutable();
              boardStatus_.addAll(other.boardStatus_);
            }
            onChanged();
          }
        } else {
          if (!other.boardStatus_.isEmpty()) {
            if (boardStatusBuilder_.isEmpty()) {
              boardStatusBuilder_.dispose();
              boardStatusBuilder_ = null;
              boardStatus_ = other.boardStatus_;
              bitField0_ = (bitField0_ & ~0x00080000);
              boardStatusBuilder_ = 
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders ?
                   getBoardStatusFieldBuilder() : null;
            } else {
              boardStatusBuilder_.addAllMessages(other.boardStatus_);
            }
          }
        }
        if (other.hasPlayer1UnlimitedMovesOn()) {
          setPlayer1UnlimitedMovesOn(other.getPlayer1UnlimitedMovesOn());
        }
        if (other.hasPlayer2UnlimitedMovesOn()) {
          setPlayer2UnlimitedMovesOn(other.getPlayer2UnlimitedMovesOn());
        }
        if (other.hasRingmasterActionType()) {
          setRingmasterActionType(other.getRingmasterActionType());
        }
        if (other.hasBlockWasEffective()) {
          setBlockWasEffective(other.getBlockWasEffective());
        }
        if (other.hasBlockWindowID()) {
          setBlockWindowID(other.getBlockWindowID());
        }
        if (other.hasBlockWindowHasExpired()) {
          setBlockWindowHasExpired(other.getBlockWindowHasExpired());
        }
        if (other.hasBlockWindowTimeInSecs()) {
          setBlockWindowTimeInSecs(other.getBlockWindowTimeInSecs());
        }
        if (other.hasBlockingPlayerNumber()) {
          setBlockingPlayerNumber(other.getBlockingPlayerNumber());
        }
        if (other.hasOldActionPoints()) {
          setOldActionPoints(other.getOldActionPoints());
        }
        if (other.hasNewActionPoints()) {
          setNewActionPoints(other.getNewActionPoints());
        }
      ...
      public Builder mergeFrom(
        ...
        while (true) {
          ...
          switch (tag) {
            ...
            case 170: {
              ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder subBuilder = ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.newBuilder();
              input.readMessage(subBuilder, extensionRegistry);
              addBoardStatus(subBuilder.buildPartial());
              break;
            }
            case 176: {
              bitField0_ |= 0x00100000;
              player1UnlimitedMovesOn_ = input.readBool();
              break;
            }
            case 184: {
              bitField0_ |= 0x00200000;
              player2UnlimitedMovesOn_ = input.readBool();
              break;
            }
            case 192: {
              int rawValue = input.readEnum();
            ...
            case 200: {
              ...
              blockWasEffective_ = input.readBool();
              break;
            }
            case 208: {
              bitField0_ |= 0x01000000;
              blockWindowID_ = input.readInt32();
              break;
            }
            case 216: {
              bitField0_ |= 0x02000000;
              blockWindowHasExpired_ = input.readBool();
              break;
            }
            case 225: {
              bitField0_ |= 0x04000000;
              blockWindowTimeInSecs_ = input.readDouble();
              break;
            }
            case 232: {
              bitField0_ |= 0x08000000;
              blockingPlayerNumber_ = input.readInt32();
              break;
            }
            case 245: {
              bitField0_ |= 0x10000000;
              oldActionPoints_ = input.readFloat();
              break;
            }
            case 253: {
              bitField0_ |= 0x20000000;
              newActionPoints_ = input.readFloat();
              break;
            }
            case 256: {
              int rawValue = input.readEnum();
              ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason value = ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason.valueOf(rawValue);
              if (value == null) {
                unknownFields.mergeVarintField(32, rawValue);
              } else {
                bitField0_ |= 0x40000000;
                attackFailureReason_ = value;
              }
              break;
            }
            case 269: {
      ...
      private java.util.List<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus> boardStatus_ =
        java.util.Collections.emptyList();
      private void ensureBoardStatusIsMutable() {
        if (!((bitField0_ & 0x00080000) == 0x00080000)) {
          boardStatus_ = new java.util.ArrayList<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus>(boardStatus_);
          bitField0_ |= 0x00080000;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder> boardStatusBuilder_;
      
      public java.util.List<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus> getBoardStatusList() {
        if (boardStatusBuilder_ == null) {
          return java.util.Collections.unmodifiableList(boardStatus_);
        } else {
          return boardStatusBuilder_.getMessageList();
        }
      }
      public int getBoardStatusCount() {
        if (boardStatusBuilder_ == null) {
          ...
          return boardStatusBuilder_.getCount();
        }
      }
      public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus getBoardStatus(int index) {
        if (boardStatusBuilder_ == null) {
          ...
          return boardStatusBuilder_.getMessage(index);
        }
      }
      public Builder setBoardStatus(
          int index, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus value) {
        if (boardStatusBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureBoardStatusIsMutable();
          boardStatus_.set(index, value);
          onChanged();
        } else {
          boardStatusBuilder_.setMessage(index, value);
        }
        return this;
      }
      public Builder setBoardStatus(
          int index, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder builderForValue) {
        if (boardStatusBuilder_ == null) {
          ensureBoardStatusIsMutable();
          boardStatus_.set(index, builderForValue.build());
          onChanged();
        } else {
          boardStatusBuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      public Builder addBoardStatus(ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus value) {
        if (boardStatusBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureBoardStatusIsMutable();
          boardStatus_.add(value);
          onChanged();
        } else {
          boardStatusBuilder_.addMessage(value);
        }
        return this;
      }
      public Builder addBoardStatus(
          int index, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus value) {
        if (boardStatusBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          ...
          ensureBoardStatusIsMutable();
          boardStatus_.add(index, value);
          onChanged();
        } else {
          boardStatusBuilder_.addMessage(index, value);
        }
        return this;
      }
      public Builder addBoardStatus(
          ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder builderForValue) {
        if (boardStatusBuilder_ == null) {
          ensureBoardStatusIsMutable();
          boardStatus_.add(builderForValue.build());
          onChanged();
        } else {
          boardStatusBuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      public Builder addBoardStatus(
        ...
        if (boardStatusBuilder_ == null) {
          ensureBoardStatusIsMutable();
          boardStatus_.add(index, builderForValue.build());
          onChanged();
        } else {
          boardStatusBuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      public Builder addAllBoardStatus(
          java.lang.Iterable<? extends ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus> values) {
        if (boardStatusBuilder_ == null) {
          ensureBoardStatusIsMutable();
          super.addAll(values, boardStatus_);
          onChanged();
        } else {
          boardStatusBuilder_.addAllMessages(values);
        }
        return this;
      }
      ...
      public Builder removeBoardStatus(int index) {
        if (boardStatusBuilder_ == null) {
          ensureBoardStatusIsMutable();
          boardStatus_.remove(index);
          onChanged();
        } else {
          boardStatusBuilder_.remove(index);
        }
        return this;
      }
      public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder getBoardStatusBuilder(
          int index) {
        return getBoardStatusFieldBuilder().getBuilder(index);
      }
      public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder getBoardStatusOrBuilder(
          int index) {
        if (boardStatusBuilder_ == null) {
          return boardStatus_.get(index);  } else {
          return boardStatusBuilder_.getMessageOrBuilder(index);
        }
      }
      public java.util.List<? extends ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder> 
           getBoardStatusOrBuilderList() {
        if (boardStatusBuilder_ != null) {
          return boardStatusBuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(boardStatus_);
        }
      }
      public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder addBoardStatusBuilder() {
        return getBoardStatusFieldBuilder().addBuilder(
            ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.getDefaultInstance());
      }
      public ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder addBoardStatusBuilder(
          int index) {
        return getBoardStatusFieldBuilder().addBuilder(
            index, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.getDefaultInstance());
      }
      public java.util.List<ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder> 
           getBoardStatusBuilderList() {
        return getBoardStatusFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder> 
          getBoardStatusFieldBuilder() {
        if (boardStatusBuilder_ == null) {
          boardStatusBuilder_ = new com.google.protobuf.RepeatedFieldBuilder<
              ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder, ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatusOrBuilder>(
                  boardStatus_,
      ...
      public Builder setPlayer1UnlimitedMovesOn(boolean value) {
        bitField0_ |= 0x00100000;
        player1UnlimitedMovesOn_ = value;
        onChanged();
        return this;
      }
      public Builder clearPlayer1UnlimitedMovesOn() {
        bitField0_ = (bitField0_ & ~0x00100000);
        player1UnlimitedMovesOn_ = false;
        onChanged();
        return this;
      ...
      public Builder setPlayer2UnlimitedMovesOn(boolean value) {
        bitField0_ |= 0x00200000;
        player2UnlimitedMovesOn_ = value;
        onChanged();
        return this;
      }
      public Builder clearPlayer2UnlimitedMovesOn() {
        bitField0_ = (bitField0_ & ~0x00200000);
        player2UnlimitedMovesOn_ = false;
        onChanged();
        return this;
      ...
      public Builder setBlockWasEffective(boolean value) {
        bitField0_ |= 0x00800000;
        blockWasEffective_ = value;
        onChanged();
        return this;
      }
      public Builder clearBlockWasEffective() {
        bitField0_ = (bitField0_ & ~0x00800000);
        blockWasEffective_ = false;
        onChanged();
        return this;
      ...
      public Builder setBlockWindowID(int value) {
        bitField0_ |= 0x01000000;
        blockWindowID_ = value;
        onChanged();
        return this;
      }
      public Builder clearBlockWindowID() {
        bitField0_ = (bitField0_ & ~0x01000000);
        blockWindowID_ = 0;
        onChanged();
        return this;
      ...
      public Builder setBlockWindowHasExpired(boolean value) {
        bitField0_ |= 0x02000000;
        blockWindowHasExpired_ = value;
        onChanged();
        return this;
      }
      public Builder clearBlockWindowHasExpired() {
        bitField0_ = (bitField0_ & ~0x02000000);
        blockWindowHasExpired_ = false;
        onChanged();
        return this;
      ...
      public Builder setBlockWindowTimeInSecs(double value) {
        bitField0_ |= 0x04000000;
        blockWindowTimeInSecs_ = value;
        onChanged();
        return this;
      }
      public Builder clearBlockWindowTimeInSecs() {
        bitField0_ = (bitField0_ & ~0x04000000);
        blockWindowTimeInSecs_ = 0D;
        onChanged();
        return this;
      ...
      public Builder setBlockingPlayerNumber(int value) {
        bitField0_ |= 0x08000000;
        blockingPlayerNumber_ = value;
        onChanged();
        return this;
      }
      public Builder clearBlockingPlayerNumber() {
        bitField0_ = (bitField0_ & ~0x08000000);
        blockingPlayerNumber_ = 0;
        onChanged();
        return this;
      ...
      public Builder setOldActionPoints(float value) {
        bitField0_ |= 0x10000000;
        oldActionPoints_ = value;
        onChanged();
        return this;
      }
      public Builder clearOldActionPoints() {
        bitField0_ = (bitField0_ & ~0x10000000);
        oldActionPoints_ = 0F;
        onChanged();
        return this;
      ...
      public Builder setNewActionPoints(float value) {
        bitField0_ |= 0x20000000;
        newActionPoints_ = value;
        onChanged();
        return this;
      }
      public Builder clearNewActionPoints() {
        bitField0_ = (bitField0_ & ~0x20000000);
        newActionPoints_ = 0F;
        onChanged();
        return this;
      ...
      // optional .guiprotocol.GameEvent.AttackFailureReason attackFailureReason = 32;
      private ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason attackFailureReason_ = ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason.NOT_ENOUGH_ACTION_POINTS;
      public boolean hasAttackFailureReason() {
        return ((bitField0_ & 0x40000000) == 0x40000000);
      }
      public ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason getAttackFailureReason() {
      ...
      public Builder setAttackFailureReason(ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x40000000;
      ...
      public Builder clearAttackFailureReason() {
        bitField0_ = (bitField0_ & ~0x40000000);
        attackFailureReason_ = ca.site3.ssf.guiprotocol.Event.GameEvent.AttackFailureReason.NOT_ENOUGH_ACTION_POINTS;
        onChanged();
        return this;
  ...
  private static com.google.protobuf.Descriptors.Descriptor
    internal_static_guiprotocol_GameEvent_BoardStatus_descriptor;
  private static
    com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_guiprotocol_GameEvent_BoardStatus_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "alth\030\023 \001(\002\022\030\n\020roundInPlayTimer\030\024 \001(\005\0227\n\013",
      "boardStatus\030\025 \003(\0132\".guiprotocol.GameEven" +
      "t.BoardStatus\022\037\n\027player1UnlimitedMovesOn" +
      "\030\026 \001(\010\022\037\n\027player2UnlimitedMovesOn\030\027 \001(\010\022" +
      "I\n\024ringmasterActionType\030\030 \001(\0162+.guiproto" +
      "col.GameEvent.RingmasterActionType\022\031\n\021bl" +
      "ockWasEffective\030\031 \001(\010\022\025\n\rblockWindowID\030\032" +
      " \001(\005\022\035\n\025blockWindowHasExpired\030\033 \001(\010\022\035\n\025b" +
      "lockWindowTimeInSecs\030\034 \001(\001\022\034\n\024blockingPl" +
    ...
    com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner assigner =
      new com.google.protobuf.Descriptors.FileDescriptor.InternalDescriptorAssigner() {
        public com.google.protobuf.ExtensionRegistry assignDescriptors(
          ...
          internal_static_guiprotocol_GameEvent_BoardStatus_descriptor =
            internal_static_guiprotocol_GameEvent_descriptor.getNestedTypes().get(1);
          internal_static_guiprotocol_GameEvent_BoardStatus_fieldAccessorTable = new
            com.google.protobuf.GeneratedMessage.FieldAccessorTable(
              internal_static_guiprotocol_GameEvent_BoardStatus_descriptor,
              new java.lang.String[] { "DeviceId", "Responding", "Armed", "Flame", },
              ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.class,
              ca.site3.ssf.guiprotocol.Event.GameEvent.BoardStatus.Builder.class);
          return null;
        }
      };
